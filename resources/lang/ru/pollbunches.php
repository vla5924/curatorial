...
#воробей
    ...
    'you_are_not_creator' => 'Вы не являетесь создателем этой пятиминутки',
    'some_questions_have_no_answers' => 'Некоторые вопросы не имеют правильных ответов',
    'question_has_never_been_published' => 'Вопрос никогда не был опубликован',
    'poll_not_found' => 'Опрос с вопросом не найден в качестве одного из прикреплений записей',
