...
<div class="card card-info">
    <form class="form-horizontal" method="POST" action="{{ route('groups.update', $group->id) }}">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">VK ID</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="{{ $group->vk_id }}" name="vk_id" placeholder="Integer number as community identifier" required>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Confirmation token</label>
                <div class="col-sm-10">
